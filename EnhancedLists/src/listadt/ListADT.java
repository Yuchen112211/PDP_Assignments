...
public interface ListADT<T> {
  ...
  /**
   * Reverse the current list of nodes.
   */
  public void reverse();

  /**
   * Changes this list to be a list that contains elements from
   * the original list at even positions, followed by odd positions.
   */
